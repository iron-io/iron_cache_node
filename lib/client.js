...
(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.IncrementItem = function(key, cache_name, options, cb) {
      return this.api.IncrementItem(key, cache_name, options, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
    ...
    Client.prototype.getCacheItem = function(key, cache_name, options, cb) {
      return this.api.getCacheItem(key, cache_name, options, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
   ...
   Client.prototype.deleteItem = function(key, cache_name, options, cb) {
      return this.api.deleteItem(key, cache_name, options, function(error, body) {
        if (error == null) {
          return cb(error, body);
        } else {
          return cb(error, body);
