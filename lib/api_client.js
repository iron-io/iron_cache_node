...
(function() {
  ...
  APIClient = (function(superClass) {
   ...
   APIClient.prototype.deleteCache = function(projectId, cache_name, options, cb) {
   var parseResponseBind;
   parseResponseBind = _.bind(this.parseResponse, this);
  
   var path = "/projects/" + projectId + "/caches/" + cache_name;
  
   return this.delete(path, options, function(error, response, body) {
   return parseResponseBind(error, response, body, cb);
  });
};
