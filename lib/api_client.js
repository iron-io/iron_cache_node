...
(function() {
  ...
  APIClient = (function(superClass) {
    ...
    APIClient.prototype.getItem = function(key, cache_name, options, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
    ...
    APIClient.prototype.deleteItem = function(key, cache_name, options, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this["delete"]("/" + cache_name + "/items/" + key, options, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    };
